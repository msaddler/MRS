...
%CLIM_a = [-70, 10]; % Accelerometer colorbar limits                       <--- currently not used
%FLIM_a = [0 250]; % Accelerometer spectrogram frequency limits (Hz)       <--- currently not used
    ...
    function callback_pushbutton(source,~)
        switch source
            ...
            case c_loadacc
                ...
                [FileName,PathName] = uigetfile(['G:\Mark\data_bm\',aTag],...
