function signalParams = dtagcorrelate_noise_only(savedSignals,varargin)
% MS 2017.07.07
...
for i = 1:size(savedSignals,1)
    ...
    O_dec = savedSignals{i,1}.noise_post; % Grab audio noise!
    A_dec = savedSignals{i,2}.noise_post; % Grab accel noise!
    O_dec = decimate(O_dec, 2); % Decimate audio noise to accel fs!
