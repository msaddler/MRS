function [t, E, I, J_E, J_I, F_E, F_I] = get_WC_deterministic(...
...
% Model weights
% Synaptic Weights                    % Known limit cycle weights
W_ee = mean(mean(W(excIdx, excIdx))); % 16
W_ie = mean(mean(W(inhIdx, excIdx))); % 18
W_ei = mean(mean(W(excIdx, inhIdx))); % 12
W_ii = mean(mean(W(inhIdx, inhIdx))); % 3
